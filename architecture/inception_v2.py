...
InceptionV2_ModuleA = (
    ...
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleA_a_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 64], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleA_b_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleA_b_2_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleA_a_concat']}},
    ...
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleA_c_1_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 160], 'stride_size': [1, 2, 2, 1], 'padding': 'SAME', 'name': 'moduleA_c_1_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleA_b_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 64], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleA_c_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleA_c_2_2_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 96], 'stride_size': [1, 2, 2, 1], 'padding': 'SAME', 'name': 'moduleA_c_2_3_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleA_b_concat']}},
...
InceptionV2_ModuleB = (
    ...
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_a_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_2_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_a_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_3_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_3_2_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_3_3_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_a_concat']}},
    {'method': layer_temp.avg_pool, 'kwargs': {'kernel_size': [1, 3, 3, 1], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_4_1_avgpool'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_b_4_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['moduleB_b_1_conv', 'moduleB_b_2_2_conv', 'moduleB_b_3_3_conv', 'moduleB_b_4_2_conv']}},
    {'method': activation.Concatenate, 'kwargs': {'name': 'ModuleB_b_concat'}},

    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_b_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 160], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_1_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_b_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 160], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_2_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_b_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_3_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 160], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_3_2_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 160], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_3_3_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_b_concat']}},
    {'method': layer_temp.avg_pool, 'kwargs': {'kernel_size': [1, 3, 3, 1], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_4_1_avgpool'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_c_4_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['moduleB_c_1_conv', 'moduleB_c_2_2_conv', 'moduleB_c_3_3_conv', 'moduleB_c_4_2_conv']}},
    {'method': activation.Concatenate, 'kwargs': {'name': 'ModuleB_c_concat'}},

    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_c_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_1_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_c_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 192], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_2_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_c_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 160], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_3_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 192], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_3_2_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 192], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_3_3_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_c_concat']}},
    {'method': layer_temp.avg_pool, 'kwargs': {'kernel_size': [1, 3, 3, 1], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_4_1_avgpool'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 96], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_d_4_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['moduleB_d_1_conv', 'moduleB_d_2_2_conv', 'moduleB_d_3_3_conv', 'moduleB_d_4_2_conv']}},
    {'method': activation.Concatenate, 'kwargs': {'name': 'ModuleB_d_concat'}},

    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_d_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 128], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_e_1_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 192], 'stride_size': [1, 2, 2, 1], 'padding': 'SAME', 'name': 'moduleB_e_1_2_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_d_concat']}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [1, 1, -1, 192], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_e_2_1_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 256], 'stride_size': [1, 1, 1, 1], 'padding': 'SAME', 'name': 'moduleB_e_2_2_conv'}},
    {'method': layer.conv_2d, 'kwargs': {'kernel_size': [3, 3, -1, 256], 'stride_size': [1, 2, 2, 1], 'padding': 'SAME', 'name': 'moduleB_e_2_3_conv'}},
    {'method': util.LayerSelector, 'kwargs': {'names': ['ModuleB_d_concat']}},
    {'method': layer.max_pool, 'kwargs': {'kernel_size': [1, 3, 3, 1], 'stride_size': [1, 2, 2, 1], 'padding': 'SAME', 'name': 'moduleB_e_3_maxpool'}},
